...
<head>
	<meta charset="UTF-8">
	<title>Create Title Value</title>
	...
	<div class=" container border border-primary ">
		...
		<div class=" row border border-primary ">
			...
			<div class=" col-sm-8 border border-primary ">
				<form:form action="/title/${ titleId }/create-statInc" method="post" modelAttribute="statInc">
				    <div class="">
				...
				<a href="/view-title/${ titleId }"><button>Cancel</button></a>
			</div>
			<div class=" col-sm-2 border border-primary ">
				<div>
