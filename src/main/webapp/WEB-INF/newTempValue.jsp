...
<head>
	<meta charset="UTF-8">
	<title>Create Template Value</title>
	...
	<div class=" container border border-primary ">
		...
		<div class=" row border border-primary ">
			...
			<div class=" col-sm-8 border border-primary ">
				<form:form action="/template/${tempId}/create-statInc" method="post" modelAttribute="statInc">
				    <div class="">
				    ...
				    <div>
				        ...
				        <form:input type="number" path="incAmt"/> <!-- type="number" -->
				        <form:errors class="error" path="incAmt"/>
				    </div>
				    <div class="">
					    <input type="submit" value="Submit" />
				    </div>
				</form:form>
				<a href="/view-template/${ tempId }"><button>Cancel</button></a>
			</div>
			<div class=" col-sm-2 border border-primary ">
				<div>
