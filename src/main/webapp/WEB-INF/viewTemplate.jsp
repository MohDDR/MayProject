...
<head>
	<meta charset="UTF-8">
	<title><c:out value="${template.name}"/></title>
	...
	<div class=" container border border-primary ">
		...
		<div class=" row border border-primary ">
			...
			<div class=" col-sm-8 border border-primary ">
				<h6>Template</h6>
				<a href="/view-template/${ template.id }/create-skill"><button>Save Template as Skill</button></a>
				
					<p><c:out value="${ template.name }"/></p>
					<a href="/edit-template/${template.id}">Edit</a>
				<h6>Stat Increments</h6>
				<a href="/template/${template.id}/create-statInc">New Stat Change</a>
				<c:forEach var="statInc" items="${ template.statIncs }">
